...
// crud交由presenter持有
const defaultForm = { id: null, name: null, price: null, picName: null, picPath: null, shipRule: null, boxDescribe: null, boxSort: 999 }
export default {
  name: 'Box',
  components: { crudOperation, rrOperation, udOperation, DateRangePicker, pagination },
  cruds() {
    return CRUD({ title: '盲盒', url: 'api/box', crudMethod: { ...crudBox }})
  },
